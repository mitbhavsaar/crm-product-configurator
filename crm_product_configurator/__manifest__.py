# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'crm_product_configurator/static/src/js/product/product_responsive.scss',
            'crm_product_configurator/static/src/js/product_template_attribute_line/product_template_attribute_line.scss',
            'crm_product_configurator/static/src/js/product_configurator_dialog/product_configurator_dialog.scss'
        ],
    },
    'installable': True,
    'auto_install': False,
